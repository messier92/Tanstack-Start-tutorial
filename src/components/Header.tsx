    ...
    <header className="sticky top-0 z-40 border-b 
      ...
      <div className="mx-auto max-w-6xl px-4 py-3 
        ...
        <div className="flex items-center gap-3">
          ...
          <nav className="hidden items-center gap-3 text-sm 
        ...
        <div className="flex items-center gap-2">
          <Link to="/cart" className="inline-flex items-center gap-2
                rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-800 shadow-sm 
                transition hover:-translate-y-0.5 hover:shadow-md"
          >
            <span>Cart</span>
            <span className="flex h-6 min-w-6 items-center justify-center rounded-full bg-slate-900 px-2 text-[11px] font-bold text-white">0</span>
